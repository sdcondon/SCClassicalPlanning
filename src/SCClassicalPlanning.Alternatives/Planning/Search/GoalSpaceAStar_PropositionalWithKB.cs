...
namespace SCClassicalPlanning.Planning.Search
{
    ...
    /// </summary>
    public class GoalSpaceAStar_PropositionalWithKB : IPlanner
    {
        private readonly ICostStrategy costStrategy;
        private readonly InvariantInspector? invariantInspector;

        /// <summary>
        /// Initializes a new instance of the <see cref="GoalSpaceAStar_PropositionalWithKB"/> class.
        /// </summary>
        /// <param name="costStrategy">The strategy to use.</param>
        public GoalSpaceAStar_PropositionalWithKB(ICostStrategy costStrategy, IKnowledgeBase? invariantsKB = null)
        {
