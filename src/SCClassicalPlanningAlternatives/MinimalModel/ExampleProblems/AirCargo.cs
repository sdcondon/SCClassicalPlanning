...
namespace SCClassicalPlanningAlternatives.MinimalModel.ExampleProblems
{
    ...
    public class AirCargo
    {
        ...
        /// </summary>
        public static State ImplicitState => Cargo(Cargo1) & Cargo(Cargo2) & Plane(Plane1) & Plane(Plane2) & Airport(JFK) & Airport(SFO);

        public static Literal At(Variable @object, Variable location) => new Literal(nameof(At), @object, location);
        public static Literal In(Variable @object, Variable container) => new Literal(nameof(In), @object, container);
        public static Literal Cargo(Variable cargo) => new Literal(nameof(Cargo), cargo);
        public static Literal Plane(Variable plane) => new Literal(nameof(Plane), plane);
        public static Literal Airport(Variable airport) => new Literal(nameof(Airport), airport);
