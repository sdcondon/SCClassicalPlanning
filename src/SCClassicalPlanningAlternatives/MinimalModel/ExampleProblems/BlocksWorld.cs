...
namespace SCClassicalPlanningAlternatives.MinimalModel.ExampleProblems
{
    ...
    public class BlocksWorld
    {
        ...
        /// </summary>
        public static State ImplicitState => Block(BlockA) & Block(BlockB) & Block(BlockC);

        public static Literal On(Variable above, Variable below) => new Literal(nameof(On), above, below);
        public static Literal Block(Variable block) => new Literal(nameof(Block), block);
        public static Literal Clear(Variable surface) => new Literal(nameof(Clear), surface);
        public static Literal Equal(Variable x, Variable y) => new Literal(nameof(Equal), x, y);
