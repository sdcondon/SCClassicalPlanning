...
{
    /// <summary>
    /// Implementation of <see cref="IStrategy"/> that just invokes given delegates.
    /// </summary>
    public class DelegateStrategy : IStrategy
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="DelegateStrategy"/> class.
        /// </summary>
        ...
        public DelegateStrategy(Func<Action, float> getCost, Func<State, Goal, float> estimateCost)
        {
