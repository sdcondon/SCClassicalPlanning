...
namespace SCClassicalPlanning.Planning.StateSpaceSearch.Heuristics
{
    ...
    /// <para/>
    /// This heuristic isn't driven by any particular source material,
    ...
    public class InvariantCheck
    {
        ...
        public float EstimateCost(State state, Goal goal)
        {
            ...
            // Awkwardness - goals are super-easy to convert to CNF, but our knowledge bases want to do that themselves.. 
            // Meh, never mind.
            ...
            // be true (that will of course generally not be the case!), we're asking if the state element
            // CANNOT be true - that is, if its negation must be.
