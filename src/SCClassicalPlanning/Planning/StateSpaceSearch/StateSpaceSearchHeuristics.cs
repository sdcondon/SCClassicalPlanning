namespace SCClassicalPlanning.Planning.StateSpaceSearch
{
    public static class StateSpaceSearchHeuristics
    {
        ...
        /// <summary>
        /// Very dumb heuristic that just adds the number of positive elements of the goal that do not occur in the state
        /// to the number of negative elements that do (that is, assumes that we need to carry out one action per element of
