...
Note that while this is a significantly smaller model than that capable of being expressed with even the earliest versions of [Planning Domain Definition Language](https://en.wikipedia.org/wiki/Planning_Domain_Definition_Language), it does go further than chapter 10 of AIaMA.
I do feel chapter 10 is one of the weaker chapters of the source material.
This library goes a bit further - partly out of necessity (to create a coherent set of funtionality), and partly to "bridge the gap" so to speak between the rough ideas presented by this chapter and real, production-ready planners.
