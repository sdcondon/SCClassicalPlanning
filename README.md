...
This library goes a bit further - partly out of necessity (to create a coherent set of functionality), and partly to "bridge the gap" so to speak between the rough ideas presented by this chapter and real, production-ready planners.
